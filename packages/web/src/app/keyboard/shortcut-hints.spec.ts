...
describe('describeKeyBindings', () => {
  it('turns the shipped layout into readable localized hints', () => {
    expect(describeKeyBindings(defaultKeyBindings)).toEqual([
      ...
      { keys: '[', description: i18n._('shortcuts.tempo-down') },
      { keys: ']', description: i18n._('shortcuts.tempo-up') },
      { keys: '{', description: i18n._('shortcuts.pitch-down') },
      { keys: '}', description: i18n._('shortcuts.pitch-up') },
