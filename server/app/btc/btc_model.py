"""BTC chord-recognition model, vendored from jayg996/BTC-ISMIR19 (MIT).

Source: https://github.com/jayg996/BTC-ISMIR19 (btc_model.py), trimmed to
inference (training entrypoint dropped, imports made relative). Kept verbatim
otherwise so the published `btc_model.pt` checkpoint loads unchanged; excluded
from ruff/pyright/coverage like the other ML shells.
"""

from .transformer_modules import *  # noqa: F403
from .transformer_modules import _gen_bias_mask, _gen_timing_signal  # noqa: F401
