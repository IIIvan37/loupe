"""Transformer building blocks, vendored from jayg996/BTC-ISMIR19 (MIT).

Source: https://github.com/jayg996/BTC-ISMIR19 (utils/transformer_modules.py).
Only the removed `np.float` alias was replaced by `float` (NumPy >= 1.20);
otherwise verbatim, so the published checkpoint's tensor names still match.
"""
