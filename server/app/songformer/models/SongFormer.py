...
except Exception:  # loupe: msaf is eval-only, not vendored (inference doesn't call it)
    def compute_results(*args, **kwargs):
        raise RuntimeError("msaf.eval.compute_results unavailable (inference-only build)")
