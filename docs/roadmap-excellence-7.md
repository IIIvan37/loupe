...
- **AM.4** — ~~EQ lisible + niveaux vivants : Hz affichés par slider + reset
  ...
  par le tap analyser, distinct du fader statique.~~ **Écarté (2026-07-22,
  décision produit)** : apporte peu à l'outil de pratique. **Lot AM clos**
  (AM.1/AM.2 livrées, AM.3/AM.4 écartées).
